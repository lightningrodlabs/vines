...
#[hdk_extern]
pub fn get_anchor_children(anchor: String) -> ExternResult<Vec<(u8, String)>> {
...
///
pub fn convert_paths_to_str(children_tp: Vec<(u8, TypedPath)>) -> ExternResult<Vec<(u8, String)>> {
  let mut res = Vec::new();
