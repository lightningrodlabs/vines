...
// @ts-ignore
import {
  AUTHORSHIP_DEFAULT_COORDINATOR_ZOME_NAME,
  AUTHORSHIP_DEFAULT_INTEGRITY_ZOME_NAME,
  AUTHORSHIP_DEFAULT_ROLE_NAME,
  ROOT_ANCHOR_AUTHORSHIP,
  ROOT_ANCHOR_UNKNOWN_AUTHOR,
  AuthorshipEntry,
  AscribeTargetInput,
  AuthorshipLog,
  Bogus,
} from './authorship.types';
// @ts-ignore
import {
  /** api/common.ts */
// @ts-ignore
