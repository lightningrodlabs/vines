...
// @ts-ignore
import {AUTHORSHIP_DEFAULT_COORDINATOR_ZOME_NAME, AUTHORSHIP_DEFAULT_INTEGRITY_ZOME_NAME, AUTHORSHIP_DEFAULT_ROLE_NAME, ROOT_ANCHOR_AUTHORSHIP, ROOT_ANCHOR_UNKNOWN_AUTHOR, AuthorshipEntry, AscribeTargetInput, AuthorshipLog, Bogus, GetAgentInput, GetAhInput, GetDataTypeInput, GetDhInput, GetEhInput, GetLhInput, GetManyAgentInput, GetManyAhInput, GetManyDhInput, GetManyEhInput, GetManyLhInput, MyValidationReceiptInfo, MyValidationReceiptSet, } from './authorship.types';
// @ts-ignore
import {
/** api/common.ts */
// @ts-ignore
...
import {AuthorshipUnitEnum} from './authorship.integrity';
import {AuthorshipLinkType} from './authorship.integrity';

/**
 *
 */
export class AuthorshipProxy extends ZomeProxy {
  static override readonly DEFAULT_ZOME_NAME = "zAuthorship";
  static override readonly FN_NAMES = authorshipFunctionNames;
  static override readonly ENTRY_TYPES = Object.values(AuthorshipUnitEnum);
  static override readonly LINK_TYPES = Object.values(AuthorshipLinkType);
  ...
  async getAuthor(input: GetLhInput): Promise<[Timestamp, AgentArray] | null> {
    return this.call('get_author', input);
  }

  async getAuthors(input: GetManyLhInput): Promise<Record<string, AnyLinkableArray>> {
    return this.call('get_authors', input);
  }
