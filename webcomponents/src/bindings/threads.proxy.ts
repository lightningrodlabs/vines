...
import {DM_SUBJECT_TYPE_NAME, GLOBAL_TIME_INDEX, PP_ITEM_TYPE, ROOT_ANCHOR_SEMANTIC_TOPICS, ROOT_ANCHOR_SUBJECTS, SEMANTIC_TOPIC_TYPE_NAME, THREADS_DEFAULT_COORDINATOR_ZOME_NAME, THREADS_DEFAULT_INTEGRITY_ZOME_NAME, VINES_DEFAULT_ROLE_NAME, BaseBeadKind, NotifySetting, StateChange, SystemSignalProtocol, ThreadsEntry, ThreadsLinkType, ThreadsSignalProtocol, TipProtocol, AddAnyBeadInput, AddEncBeadInput, AddEntryAsBeadInput, AddEntryBeadInput, AddManyTextBeadAtInput, AddReactionInput, AddTextBeadAtInput, AnyBead, Bead, BeadLink, BroadcastTipInput, CastNotificationTipInput, CommitGlobalLogInput, DecryptBeadInput, EncryptBeadInput, EncryptedBead, EntryBead, EntryPulse, FindSubjectsInput, GetDataTypeInput, GetLatestBeadsInput, GlobalLastProbeLog, LinkPulse, NotifyPeerInput, ParticipationProtocol, ProbeAllOutput, SemanticTopic, SetNotifySettingInput, Subject, SystemSignal, TextBead, ThreadLastProbeLog, ThreadsProperties, ThreadsSignal, TipSignal, UpdateTopicInput, } from './threads.types';
import {
...
export class ThreadsProxy extends ZomeProxy {
  ...
  async castNotificationTip(input: CastNotificationTipInput): Promise<void> {
