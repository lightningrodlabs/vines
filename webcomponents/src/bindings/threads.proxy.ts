...
import {GLOBAL_TIME_INDEX, PP_ITEM_TYPE, ROOT_ANCHOR_SEMANTIC_TOPICS, ROOT_ANCHOR_SUBJECTS, SEMANTIC_TOPIC_TYPE_NAME, THREADS_DEFAULT_COORDINATOR_ZOME_NAME, THREADS_DEFAULT_INTEGRITY_ZOME_NAME, THREADS_DEFAULT_ROLE_NAME, DirectMessage, ThreadsEntry, ThreadsLinkType, AddAnyAsBead, AddManyTextMessageAtInput, AddTextAndMentionsAtInput, AddTextMessageAtInput, AddTextWithMentionsInput, Bead, BeadLink, CreatePpInput, GetLatestBeadsInput, GetProtocolsInput, GlobalLastProbeLog, NotifyInput, ParticipationProtocol, ProbeAllLatestOutput, SemanticTopic, SignalPayload, Subject, TextMessage, ThreadLastProbeLog, } from './threads.types';
import {
/** types.ts */
HoloHash,
AgentPubKey,
...
export class ThreadsProxy extends ZomeProxy {
  ...
  async addAnyAsBead(input: AddAnyAsBead): Promise<[string, string, Timestamp]> {
    return this.call('add_any_as_bead', input);
  }
  ...
  async addTextMessageAtWithMentions(input: AddTextAndMentionsAtInput): Promise<[ActionHash, string]> {
