...
export class ThreadsProxy extends ZomeProxy {
  ...
  async mentionAgent(input: MentionAgentsInput): Promise<ActionHash> {
    return this.call('mention_agent', input);
  }
