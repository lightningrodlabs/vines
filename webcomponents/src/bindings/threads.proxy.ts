...
export class ThreadsProxy extends ZomeProxy {
  ...
  async notifyDm(input: NotifyDmInput): Promise<WeaveNotification> {
    return this.call('notify_dm', input);
  }
